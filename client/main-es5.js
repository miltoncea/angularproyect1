...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent.prototype.resetSlider = function () {
        this.anchuraToSlider = 0;
        this.widthSlider = 0;
    };
...
var CreateProyectComponent = /** @class */ (function () {
    function CreateProyectComponent(_proyectService, _uploadService) {
    ...
    CreateProyectComponent.prototype.ngOnInit = function () {
    };
    CreateProyectComponent.prototype.onSubmit = function (form) {
        var _this = this;
        this._proyectService.saveProyect(this.proyect)
            ...
            if (response.proyect) {
                ...
                _this._uploadService.makeFileRequest(_services_global__WEBPACK_IMPORTED_MODULE_5__["Global"].url + "upload-image/" + response.proyect._id, [], _this.filesToUpload, "image")
                    ...
                    console.log(result);
                    _this.status = "succes";
                    _this.proyect_id = response.proyect._id;
                    form.reset();
                    console.log(_this.proyect_id);
                });
            }
            else {
                _this.status = "failed";
    ...
    CreateProyectComponent.prototype.fileChangeEvent = function (fileInput) {
        this.filesToUpload = fileInput.target.files;
    };
    CreateProyectComponent.ctorParameters = function () { return [
...
var EditProyectComponent = /** @class */ (function () {
    function EditProyectComponent(_proyectService, _router, _route) {
        this._proyectService = _proyectService;
    ...
    EditProyectComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    EditProyectComponent.prototype.getProyect = function (id) {
        var _this = this;
        this._proyectService.getProyect(id).subscribe(function (response) {
            _this.proyect = response.Proyect;
            console.log(_this.proyect);
        }, function (error) {
            console.log(error);
        });
    };
    EditProyectComponent.prototype.deleteProyect = function (id) {
        var _this = this;
        console.log(id);
        this._proyectService.deletedProyect(id).subscribe(function (response) {
            if (response.proyect) {
    ...
    EditProyectComponent.prototype.setConfirm = function (param) {
        this.confirm = param;
    };
    EditProyectComponent.ctorParameters = function () { return [
        { type: _services_proyect_service__WEBPACK_IMPORTED_MODULE_3__["ProyectService"] },
...
var EditComponent = /** @class */ (function () {
    function EditComponent(_uploadService, _proyectService, _route, _router) {
        this._uploadService = _uploadService;
        this._proyectService = _proyectService;
        this._route = _route;
        this._router = _router;
    ...
    EditComponent.prototype.getProyect = function (id) {
        var _this = this;
        this._proyectService.getProyect(id).subscribe(function (response) {
            _this.proyect = response.Proyect;
            console.log(_this.proyect);
...
var ProyectsComponent = /** @class */ (function () {
    function ProyectsComponent(_proyectService) {
        this._proyectService = _proyectService;
    ...
    ProyectsComponent.prototype.getProyects = function () {
        var _this = this;
        this._proyectService.getProyects().subscribe(function (response) {
            console.log(response);
            if (response.proyects) {
                _this.proyects = response.proyects;
            }
        }, function (error) {
            console.log(error);
        });
    };
    ProyectsComponent.ctorParameters = function () { return [
...
var Proyect = /** @class */ (function () {
    function Proyect(_id, name, description, category, year, langs, image) {
        this._id = _id;
        this.name = name;
    ...
    Proyect.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var ResaltadoDirective = /** @class */ (function () {
    ...
    ResaltadoDirective.ctorParameters = function () { return [
...
var ProyectService = /** @class */ (function () {
    function ProyectService(_http) {
        this._http = _http;
        this.url = _global__WEBPACK_IMPORTED_MODULE_3__["Global"].url;
    }
    ProyectService.prototype.testService = function () {
        return 'Probando el servicio de Angular';
    };
    ProyectService.prototype.saveProyect = function (proyect) {
        var params = JSON.stringify(proyect);
